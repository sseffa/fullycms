...
<div class="pageheader">
  ...
  <div class="breadcrumb-wrapper">
    ...
    <ol class="breadcrumb">
      <li><a href="{!! url(getLang() . '/admin/news') !!}">News</a></li>
...
<div class="container">
    ...
    <div class="control-group {!! $errors->has('datetime') ? 'has-error' : '' !!}">
        ...
        <div class="controls">
            ...
            @if ($errors->first('datetime')) <span class="help-block">{!! $errors->first('datetime') !!}</span> @endif </div>
    </div>
    <br>
    ...
    <div class="control-group {!! $errors->has('content') ? 'has-error' : '' !!}">
        ...
        <div class="controls">
            ...
            @if ($errors->first('content')) <span class="help-block">{!! $errors->first('content') !!}</span> @endif </div>
    </div>
    <br>
