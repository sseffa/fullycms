...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <a rel="group" class="fancybox" href="{{ url($photo->path) }}" title="{{ $photo->title }}"><img style="border-radius: 20px;" class="lazy left" data-original="{{ url('uploads/dropzone//150x150_' . $photo->file_name) }}"/></a>
            @endforeach
        </div>
    </div>
    @endif
